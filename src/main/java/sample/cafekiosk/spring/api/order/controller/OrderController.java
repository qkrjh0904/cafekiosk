...
public class OrderController {
    ...
    public ApiResponse<CreateOrderRs> createOrder(@RequestBody @Validated OrderCreateRq rq) {
        return ApiResponse.ok(orderService.createOrder(rq, LocalDateTime.now()));
    }
}
