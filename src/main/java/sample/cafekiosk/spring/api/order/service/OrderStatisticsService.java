...
import sample.cafekiosk.spring.api.mail.service.MailService;
...
public class OrderStatisticsService {
    ...
    public boolean sendOrderStatisticsMail(LocalDate orderDate, String email) {
        ...
        List<Order> orders = orderRepository.findOrdersBy(orderDate.atStartOfDay(), orderDate.plusDays(1).atStartOfDay(), OrderStatus.PAYMENT_COMPLETED.name());
